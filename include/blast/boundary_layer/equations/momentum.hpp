...
// Solve momentum equation: tridiagonal system for F (dimensionless stream
// function) Equation: d/dη[l0 * dF/dη] - V * dF/dη - 2ξλ₀FdF/dξ + d[i] = 0
[[nodiscard]] auto solve_momentum(std::span<const double> F_previous, const coefficients::CoefficientSet& coeffs,
...
[[nodiscard]] auto build_momentum_coefficients(std::span<const double> F_previous,
...
[[nodiscard]] constexpr auto get_momentum_boundary_conditions() noexcept -> MomentumBoundaryConditions {
