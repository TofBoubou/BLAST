...
[[nodiscard]] constexpr auto solve_continuity(VField&& d_velocity_field, PhysicalQuantity auto d_eta,
                                              PhysicalQuantity auto initial_value = 0.0) noexcept -> std::vector<double>
