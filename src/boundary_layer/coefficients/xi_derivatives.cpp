...
void XiDerivatives::update_station(int station, double xi, std::span<const double> F, std::span<const double> g,
  ...
  if (station == 1) {
    ...
    lambda1_ = (xi_current_ - xi_minus_2_) / ((xi_minus_1_ - xi_current_) * (xi_minus_1_ - xi_minus_2_));
    lambda2_ = (xi_current_ - xi_minus_1_) / ((xi_minus_2_ - xi_current_) * (xi_minus_2_ - xi_minus_1_));
